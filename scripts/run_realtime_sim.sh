...
DEFAULTS_FILE="${DEFAULTS_FILE:-$ROOT_DIR/scripts/realtime_sim.defaults.env}"
...
FALLBACK_POLICY="${FALLBACK_POLICY:-empty}"
MAX_TICKS="${MAX_TICKS:-}"
OUTPUT_DIR="${OUTPUT_DIR:-local_tmp/generated_samples_realtime_sim}"
...
CMD=(
  "$PYTHON_BIN"
  "$ROOT_DIR/realtime_sim/inference_realtime_sim.py"
  --ckpt "$CKPT"
  --device "$DEVICE"
